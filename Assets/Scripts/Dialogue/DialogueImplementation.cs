...
public class DialogueImplementation : MonoBehaviour
{
	...
	public delegate void makeAnimation(object sender, string value);
	public event makeAnimation changeAnim;
	...
	public IEnumerator Say(string characterName, string text)
	{
		...
		Debug.Log ("Title: "+Dialogue.nodeTitle);

		if (Dialogue.nodeTitle == "Begin") {
			aud.clip = audio1;
			aud.Play ();
		} else if (Dialogue.nodeTitle == "First") {
			aud.clip = audio2;
			aud.Play ();
		} else if (Dialogue.nodeTitle == "Second") {
			aud.clip = audio5;
			aud.Play ();
		} else if (Dialogue.nodeTitle == "Third") {
			aud.clip = audio3;
			aud.Play ();
		} else if (Dialogue.nodeTitle == "Fourth") {
			aud.clip = audio4;
			aud.Play ();
		} else {
	...
	public void SelectOption00()
	{
		...
		if (Dialogue.nodeTitle == "Begin") {
			...
			changeAnim (this, "jump");
		} else if (Dialogue.nodeTitle == "Second") {

		} else if (Dialogue.nodeTitle == "Third") {
			changeAnim (this, "death");
		} else if (Dialogue.nodeTitle == "Fourth") {
